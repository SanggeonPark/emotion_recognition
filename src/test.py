...
from defines import test_image_folder, input_shape_2D, input_shape_3D, face_detection_model_path, emotion_recognition_model_path

face_detection = cv2.CascadeClassifier(face_detection_model_path)

model = getCNNModel()
model.load_weights(emotion_recognition_model_path)
